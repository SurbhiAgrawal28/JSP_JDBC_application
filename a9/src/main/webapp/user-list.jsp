                        ...
                        <tbody>
                            ...
                            <c:forEach var="user" items="${listUser}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${user.semester}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.specialization}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.cgpa}" />
                                    </td>
                                    <td><a href="edit?id=<c:out value='${user.studentID}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="delete?id=<c:out value='${user.studentID}' />">Delete</a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
